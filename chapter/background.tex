...
% More definition about some word like ambiguity, error recovery, syntax tree, grammar
% Don't hesitate to provide a simple definition
% Refer more bibliography as example in some section

% most known => best known
% sensible => sensitive